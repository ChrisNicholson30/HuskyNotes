...
extension Theme {
    ...
    /// A light, printer-friendly "paper" appearance used for PDF export and
    /// printing when the active theme is dark — a dark page would waste ink and
    /// read poorly on paper. Light themes export as-is (matching Read mode).
    static let paper = Theme(
        id: "paper",
        name: "Paper",
        isDark: false,
        background: HexColor("#FFFFFF"),
        surface: HexColor("#F3F3F5"),
        textPrimary: HexColor("#1A1A1A"),
        textSecondary: HexColor("#5C5C5C"),
        accent: HexColor("#1E66D0"),
        heading: HexColor("#111111"),
        link: HexColor("#1450C8"),
        codeBackground: HexColor("#F4F4F6"),
        codeText: HexColor("#1A1A1A"),
        quoteBar: HexColor("#C8C8C8"),
        selection: HexColor("#D6E4FF"),
        syntax: nil,
        bodyFont: "system",
        monoFont: "SFMono-Regular",
        bodySize: 16,
